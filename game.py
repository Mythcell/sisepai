...
def setup_game(nplayers):
    ...
    #for p in players: print(p,'with',len(p.collection),'cards')
...
def conduct_turn(verbose=True,oot_turn=False):
    ...
    global turn_count;
    #d = deck; pls = players; cp = current_player; faceups = faceup_sets; dcards = discards; ac = active_card
